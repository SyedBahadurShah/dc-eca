...
$searchSql = "SELECT * FROM clubs LEFT JOIN club_memberships ON club_memberships.club_id = clubs.club_id WHERE club_memberships.student_id = :student_id";
...
foreach ($clubs as $club) {
    ...
    $club_requirments_min = $club_requirments[0];
    $club_requirments_max = $club_requirments[1];
                    ...
                    <div class="card-body">
                        <div class="club-card-container">
                            ...
                            <div class="card club-card">
                                ...
                                <div class="card-footer">
                                    <a href="/users/students/clubs/view.php?id=<?php echo $club["club_id"]; ?>"
