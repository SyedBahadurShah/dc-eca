    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="/users/teachers/clubs"><i
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="/users/teachers/applications"><i
                            class="fa-solid fa-users-rectangle"></i> Applications</i></a>
                </li>
            </ul>
        </div>
